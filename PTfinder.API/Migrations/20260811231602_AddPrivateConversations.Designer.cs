...
namespace PTfinder.API.Migrations
{
    ...
    [Migration("20260811231602_AddPrivateConversations")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PTfinder.API.DATA.Modules.Conversation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("ClientReadAtUtc")
                        .HasColumnType("datetime2");

                    b.Property<int>("CoachId")
                        .HasColumnType("int");

                    b.Property<DateTime?>("CoachReadAtUtc")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("ClientId", "LastMessageAtUtc");

                    b.HasIndex("CoachId", "ClientId")
                        .IsUnique();

                    b.HasIndex("CoachId", "LastMessageAtUtc");

                    b.ToTable("Conversations");
                });

            modelBuilder.Entity("PTfinder.API.DATA.Modules.ConversationMessage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PTfinder.API.DATA.Modules.ConversationMessage", b =>
                {
                    b.HasOne("PTfinder.API.DATA.Modules.Conversation", "Conversation")
                        .WithMany("Messages")
